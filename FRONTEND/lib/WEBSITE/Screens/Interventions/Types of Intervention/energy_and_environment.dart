...
class EnergyAndEnvironmentScreen extends StatefulWidget {
  const EnergyAndEnvironmentScreen({Key? key}) : super(key: key);

  @override
  _EnergyAndEnvironmentScreenState createState() =>
      _EnergyAndEnvironmentScreenState();
}

class _EnergyAndEnvironmentScreenState extends State<EnergyAndEnvironmentScreen>
  ...
  late List<InterventionsProjectModel> _allEEProjects =
      <InterventionsProjectModel>[];
  ...
  Future<List<InterventionsProjectModel>> readProjectFromJsonFile() async {
    ...
    if (response.statusCode == 200) {
      setState(() {
        ...
        _allEEProjects = readJsonFileContent
            .where((element) => element.theme!.contains("D_E"))
            .toList();
        //print("ALL EE PROJECTS: _allEEProjects");
  ...
  void _runFilter({required String enteredKeyword}) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results = _allEEProjects;
    } else {
      // we use the toLowerCase() method to make it case-insensitive
      _allEEProjects.forEach((data) {
        if (data.projectName
            .toString()
            .toLowerCase()
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/energy_and_environment.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Positioned(
            ...
            child: RotatedBox(
              ...
              child: CustomPaint(
                ...
                painter: DrawEEColouredTriangle(),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                    'assets/images/energy_and_environment_logo.png',
                  ),
                  fit: BoxFit.fitWidth,
                ),
              ),
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: const Text(
            energyAndEnvironmentTheContext,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(
              left: screenSize.width / 25, right: screenSize.width / 25),
          child: const Text(
            energyAndEnvironmentOurApproach,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
              fontWeight: FontWeight.w700,
...
class DrawEEColouredTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    canvas.drawPath(path, Paint()..color = const Color(0xFFFCC30B));
  }
...
class DrawEEWhiteTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var path = Path();
    path.moveTo(size.width / 2, 0);
