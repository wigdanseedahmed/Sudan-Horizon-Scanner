            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/innovation_and_digitization.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Positioned(
            ...
            child: RotatedBox(
              ...
              child: CustomPaint(
                ...
                painter: DrawIDColouredTriangle(),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                    'assets/images/innovation_and_digitization_logo.png',
                  ),
                  fit: BoxFit.fitWidth,
                ),
              ),
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: const Text(
            innovationAndDigitizationTheContext,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(
              left: screenSize.width / 25, right: screenSize.width / 25),
          child: const Text(
            innovationAndDigitizationOurApproach,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
              fontWeight: FontWeight.w700,
...
class DrawIDColouredTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    canvas.drawPath(path, Paint()..color = const Color(0xFFFD6925));
  }
...
class DrawIDWhiteTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var path = Path();
    path.moveTo(size.width / 2, 0);
