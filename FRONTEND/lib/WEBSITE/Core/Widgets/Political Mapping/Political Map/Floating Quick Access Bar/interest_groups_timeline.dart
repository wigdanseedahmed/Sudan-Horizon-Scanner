...
class InterestGroupsTimelineScreen extends StatefulWidget {
  const InterestGroupsTimelineScreen({
    Key? key,
  ...
  @override
  _InterestGroupsTimelineScreenState createState() => _InterestGroupsTimelineScreenState();
}

class _InterestGroupsTimelineScreenState extends State<InterestGroupsTimelineScreen> with TickerProviderStateMixin {
  ...
  readPoliticalInterestGroupsFromJsonFile() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        FutureBuilder(
          future: readPoliticalInterestGroupsFromJsonFile(),
          builder: (context, data) {
            if (data.hasError) {
              ...
              return SizedBox(
                ...
                child: interestGroupsTimelineModel(),
              );
            }
          },
        ),
  ...
  interestGroupsTimelineModel() => Timeline.builder(
    itemBuilder: centerInterestGroupsTimelineBuilder,
    itemCount: searchData.length,
    physics: const NeverScrollableScrollPhysics(),
    position: TimelinePosition.Center,
  );

  TimelineModel centerInterestGroupsTimelineBuilder(BuildContext context, int i) {
