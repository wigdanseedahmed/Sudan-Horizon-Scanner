...
class HealthAndDevelopmentScreen extends StatefulWidget {
  ...
  @override
  _HealthAndDevelopmentScreenState createState() => _HealthAndDevelopmentScreenState();
}

class _HealthAndDevelopmentScreenState extends State<HealthAndDevelopmentScreen> with TickerProviderStateMixin {
  ...
  late List<InterventionsProjectModel> _allHDProjects = <InterventionsProjectModel>[];
                  ...
                  if (data.hasError) {
                    ...
                    return Column(
                      children: [
                        ...
                        BuildInterventionsProjectList(
                          allProjects: searchData, theme: "H_D", status: "past", screenSize: screenSize,),
                      ],
                    );
                  } else {
                    return const Center(
