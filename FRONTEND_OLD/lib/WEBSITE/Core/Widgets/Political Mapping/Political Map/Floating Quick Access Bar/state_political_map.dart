...
class StatePoliticalMapScreen extends StatefulWidget {
  const StatePoliticalMapScreen({Key? key, required this.screenSize}) : super(key: key);

  final Size screenSize;

  @override
  _StatePoliticalMapScreenState createState() => _StatePoliticalMapScreenState();
}

class _StatePoliticalMapScreenState extends State<StatePoliticalMapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ); //InterventionsMapWidget(mapShapeSource: _stateMapShapeSource);
  }
}
