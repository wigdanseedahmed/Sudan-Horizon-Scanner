...
class AllProjectsLocationMapWS extends StatefulWidget {
  const AllProjectsLocationMapWS({Key? key, required this.screenSize, required this.interventionScreen})
      : super(key: key);
  ...
  @override
  _AllProjectsLocationMapWSState createState() => _AllProjectsLocationMapWSState();
}

class _AllProjectsLocationMapWSState extends State<AllProjectsLocationMapWS>
