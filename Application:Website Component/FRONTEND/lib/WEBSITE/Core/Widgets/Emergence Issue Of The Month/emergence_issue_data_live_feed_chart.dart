...
class EmergenceIssueDataLiveFeedChart extends StatefulWidget {
  /// Creates the pagination chart
  const EmergenceIssueDataLiveFeedChart(Key key) : super(key: key);

  @override
  _EmergenceIssueDataLiveFeedChartState createState() => _EmergenceIssueDataLiveFeedChartState();
}


class _EmergenceIssueDataLiveFeedChartState extends State<EmergenceIssueDataLiveFeedChart> {
  ...
  Widget build(BuildContext context) {
    ...
    height = !ResponsiveWidget.isLargeScreen(context) ? height - 46 : height;
    height = ResponsiveWidget.isLargeScreen(context) && !kIsWeb ? height * 0.6 : height * 0.65;
    _containerHeight = 30;
    return Center(
              ...
              children: <Widget>[
                Row(children: <Widget>[
                  Container(
                      ...
                      height: height * 0.085,
                      width: ResponsiveWidget.isLargeScreen(context) ? 50 : width * 0.08,
  ...
  Map<int, Widget> _getButtons(Orientation orientation) {
    ...
    final Color color = DynamicTheme.of(context)?.brightness == Brightness.light
