            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/democratic_transition_and_economic_recovery.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Positioned(
            ...
            child: RotatedBox(
              ...
              child: CustomPaint(
                ...
                painter: DrawDEColouredTriangle(),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                    'assets/images/democratic_transition_and_economic_recovery_logo.png',
                  ),
                  fit: BoxFit.fitWidth,
                ),
              ),
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: const Text(
            democraticTransitionAndEconomicRecoveryOverviewPart1,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(
              left: screenSize.width / 25, right: screenSize.width / 25),
          child: const Text(
            democraticTransitionAndEconomicRecoveryOverviewPart2,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
              fontWeight: FontWeight.w700,
...
class DrawDEColouredTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    canvas.drawPath(path, Paint()..color = const Color(0xFFE5243B));
  }
...
class DrawDEWhiteTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var path = Path();
    path.moveTo(size.width / 2, 0);
