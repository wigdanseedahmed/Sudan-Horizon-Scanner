...
class StateInterventionMap extends StatefulWidget {
  const StateInterventionMap({Key? key, required this.screenSize})
      : super(key: key);

  final Size screenSize;

  @override
  _StateInterventionMapState createState() => _StateInterventionMapState();
}

class _StateInterventionMapState extends State<StateInterventionMap> {
  ///VARIABLES USED TO RETRIEVE AND FILTER THROUGH MAP DATA FROM BACKEND
  late List<StateModel> readJsonFileContent = <StateModel>[];
  late List<StateModel> searchData = <StateModel>[];

  Future<List<StateModel>> readMapDataFromJsonFile() async {
    /// Read Local Json File Directly
    /*String jsonString = await DefaultAssetBundle.of(context)
        .loadString('jsonDataFiles/interventions/interventions_state_map.json');
    //print(jsonString);*/
  ...
  void initState() {
    ...
    //_zoomPanBehavior = MapZoomPanBehavior(enablePanning: false, enablePinching: false,minZoomLevel: 1.0);
          ...
          layers: <MapShapeLayer>[
            MapShapeLayer(
              source: MapShapeSource.asset(
                ...
                searchData[index].stateNameEn!,
                //dataLabelMapper: (int index) => readJsonFileContent[index].stateNameEn!,
              ...
              legend: MapLegend(
                ...
                title: Row(
                  children: [
                    ...
                    Text(
                      'Interventions',
                      style: TextStyle(
                        fontSize: widget.screenSize.width / 50,
                ...
                textStyle: TextStyle(
                  fontSize: widget.screenSize.width / 80,
                  fontFamily: 'Montserrat',
                ),
              ),
              showDataLabels: true,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Center(
                              child: Text(
                                readJsonFileContent[index].stateNameEn!,
                                style: TextStyle(
                                    color:
                                        DynamicTheme.of(context)?.brightness ==
                                            ...
                                            ? Colors.black
                                            : Colors.white,
                                    fontSize: widget.screenSize.width / 75),
                              ),
                            ),
                            Divider(
                                    ...
                                    children: [
                                      Icon(
                                        ...
                                        color: DynamicTheme.of(context)
                                            ...
                                            ? Colors.black
                                            : Colors.white,
                                        size: widget.screenSize.width / 120,
                                      ),
                                      SizedBox(
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            ...
                                            TextSpan(
                                              text:
                                                  "${readJsonFileContent[index].shapeArea!}",
                                              style: TextStyle(
                                                color: DynamicTheme.of(context)
                                                            ?.brightness ==
                                                        Brightness.light
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            ...
                                            TextSpan(
                                              text:
                                                  "${readJsonFileContent[index].population!}",
                                              style: TextStyle(
                                                color: DynamicTheme.of(context)
                                                            ?.brightness ==
                                                        Brightness.light
                                    ...
                                    if (initialTypeOfIntervention == "All") {
                                      ...
                                      setState(() {
                                        initialLevelOfIntervention == 'Most targeted intervention type'? "Rule of Law and Constitutional Building" ==
                                            ...
                                            ? searchData = readJsonFileContent
                                            .where((StateModel state) =>
                                        state.mostInterventionType
                                            .toString() ==
                                            'R_C')
                                            .toList()
                                            : "Democratic Transition and Economic Recovery" ==
                                        ...
                                        state
                                            ...
                                            ? searchData =
                                            readJsonFileContent
                                                .where((StateModel state) => state.mostInterventionType.toString() == 'H_D')
                                                .toList()
                                            : "Peace and Stabilization" == newValue.toString()
                                            ? searchData = readJsonFileContent.where((StateModel state) => state.mostInterventionType.toString() == 'P_S').toList()
                                            : searchData = readJsonFileContent.where((StateModel state) => state.mostInterventionType.toString() == 'I_D').toList(): initialLevelOfIntervention == "Least targeted intervention type"?"Rule of Law and Constitutional Building" ==
                                            newValue
                                                .toString()

                                            ? searchData = readJsonFileContent
                                            .where((StateModel state) =>
                                        state.leastInterventionType
                                            .toString() ==
                                            'R_C')
                                            .toList()
                                            : "Democratic Transition and Economic Recovery" ==
                                        ...
                                        state
                                            ...
                                            ? searchData =
                                            readJsonFileContent
                                                .where((StateModel state) => state.leastInterventionType.toString() == 'H_D')
                                                .toList()
                                            : "Peace and Stabilization" == newValue.toString()
                                            ? searchData = readJsonFileContent.where((StateModel state) => state.leastInterventionType.toString() == 'P_S').toList()
                                            : searchData = readJsonFileContent.where((StateModel state) => state.leastInterventionType.toString() == 'I_D').toList():"Rule of Law and Constitutional Building" ==
                                            newValue
                                                .toString()

                                            ? searchData = readJsonFileContent
                                            .where((StateModel state) =>
                                        state.noInterventionType
                                            .toString() ==
                                            'R_C')
                                            .toList()
                                            : "Democratic Transition and Economic Recovery" ==
                                        ...
                                        state
                                            ...
                                            ? searchData =
                                            readJsonFileContent
                                                .where((StateModel state) => state.noInterventionType.toString() == 'H_D')
                                                .toList()
                                            : "Peace and Stabilization" == newValue.toString()
                                            ? searchData = readJsonFileContent.where((StateModel state) => state.noInterventionType.toString() == 'P_S').toList()
                                            : searchData = readJsonFileContent.where((StateModel state) => state.noInterventionType.toString() == 'I_D').toList();
                                      });
                                    }
                                  });
                                },
