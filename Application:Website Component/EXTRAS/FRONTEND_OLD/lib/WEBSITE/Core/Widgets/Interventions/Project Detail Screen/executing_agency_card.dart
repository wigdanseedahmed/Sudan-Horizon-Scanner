...
class ExecutingAgencyCard extends StatelessWidget {
  const ExecutingAgencyCard({Key? key, required this.selectedProject, required this.index, required this.screenSize, required this.interventionScreen,}) : super(key: key);
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        selectedProject.executingAgency![index].executingAgencyName!,
