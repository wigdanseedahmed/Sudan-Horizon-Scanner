            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/rule_of_law.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Positioned(
            ...
            child: RotatedBox(
              ...
              child: CustomPaint(
                ...
                painter: DrawRCColouredTriangle(),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                    'assets/images/rule_of_law_logo.png',
                  ),
                  fit: BoxFit.fitWidth,
                ),
              ),
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: const Text(
            ruleOfLawAndJusticeReformOverviewPart1,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(
              left: screenSize.width / 25, right: screenSize.width / 25),
          child: const Text(
            ruleOfLawAndJusticeReformOverviewPart2,
            style: TextStyle(
              fontSize: 18,
              fontFamily: 'Montserrat',
              fontWeight: FontWeight.w700,
...
class DrawRCColouredTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    canvas.drawPath(path, Paint()..color = const Color(0xFF00689D));
  }
...
class DrawRCWhiteTriangle extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    var path = Path();
    path.moveTo(size.width / 2, 0);
